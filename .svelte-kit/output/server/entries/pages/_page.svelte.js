...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_tasks();
  return `<div class="p-6 grid gap-4 svelte-uufmj0"> ${each(projects || [], (data) => {
