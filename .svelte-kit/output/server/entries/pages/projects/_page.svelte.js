...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="p-3 flex gap-1 pc-1"><button class="bg-green-200" data-svelte-h="svelte-1u4z6nm">Create Project</button> <button class="bg-green-200 ml-auto" data-svelte-h="svelte-11kucpw">Backup</button>  <input type="file"></div> <div class="p-3 grid gap-2 svelte-1kbnvm6">${each($projects || [], (data) => {
